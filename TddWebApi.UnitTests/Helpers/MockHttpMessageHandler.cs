...
namespace TddWebApi.UnitTests.Helpers;

public static class MockHttpMessageHandler<T>
{
    public static Mock<HttpMessageHandler> SetupBasicGetResourcesList(List<T> expectedResponse)
    {
    ...
    public static Mock<HttpMessageHandler> SetupBasicGetResourcesList(List<T> expectedResponse, string endpoint)
    {
        var mockResponse = new HttpResponseMessage(System.Net.HttpStatusCode.OK)
        {
            Content = new StringContent(JsonConvert.SerializeObject(expectedResponse))
